  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <div
        ...
        style={{ borderBottom: "1px solid #e5e7eb", boxShadow: "0 1px 8px 0 rgba(0,0,0,0.06)" }}
      >
        <div className="px-5 py-0 flex items-center justify-between gap-4 h-[60px]">

          {/* ── LEFT: PG-GROUP branding ── */}
          <div className="flex items-center gap-3 flex-shrink-0">
            {/* Logo circle with red bg fallback */}
            <div
            ...
            <div className="leading-none">
              <div
                ...
                style={{ color: "#A11313", letterSpacing: "-0.3px" }}
              >
                PG-GROUP
              </div>
              <div className="text-[10px] font-medium text-red-800A15A13 mt-0.5 tracking-wide uppercase">
                Paint Shop MIS
              </div>
            </div>
            ...
            {/* Page title */}
            <div>
              <div className="text-sm font-bold text-slate-800 leading-none">Production Entry</div>
              <div className="text-[10px] text-slate-600 mt-0.5">Daily Shift Report</div>
            </div>
          ...
          <div className="flex items-center gap-2 flex-wrap justify-center flex-1">
            ...
            >
              ...
              <span className="text-xs text-slate-600 font-mono">{now.format("DD MMM YYYY")}</span>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            >
              ...
              <div className="leading-none">
                ...
                <div className="text-[10px] text-black-400 mt-0.5">{user?.email || "—"}</div>
              </div>
            </div>

            {/* Plant pill */}
            <div
              className="flex items-center gap-2 px-3 py-1.5 rounded-lg hidden md:flex"
              style={{ background: "#f8fafc", border: "1px solid #e2e8f0" }}
            >
            ...
            >
              {shift === "Day" ? <Sun size={12} /> : <Moon size={12} />}
              {shift}
            </div>
